...
<div class="user-post clearfix">
	<a class="user-post-comment" href="<?php comments_link(); ?>" title="<?php _e('Responce on this post', 'profile') ?>"><?php comments_number( '0', '1', '%d'); ?></a>
	<?php if(get_query_var('profile_cpt') == '') :  $type = get_post_type() ?>
